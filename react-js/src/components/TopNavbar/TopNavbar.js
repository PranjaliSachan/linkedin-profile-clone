...
function TopNavbar() {
    return (
        <header id="linkedin-profile-header" className="header">
            <a href="#" target="_blank" className="header-icon">
                ...
                <ul className="nav-list">
                    ...
                    <li>
                        <button className="profile-btn">
                            <img width="24"
                                src="https://media.licdn.com/dms/image/D4E03AQGxTIvlyEoE8Q/profile-displayphoto-shrink_100_100/0/1710105676256?e=1719446400&amp;v=beta&amp;t=zy6-xY9O__S-TSkreb4fcC4tr00b32hFQ1b5gAhdtZg"
                                height="24" alt="Pranjali Sachan" id="ember17" />
                    ...
                    <li>
                        <button>
                            <div className="for-business-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24"
                                    fill="currentColor" className="mercado-match" width="24" height="24" focusable="false">
                                    <path
                            ...
                            <span className="for-business-text">
                                For Business
                                <i className="bi bi-caret-down-fill"></i>
                            </span>
                        </button>
